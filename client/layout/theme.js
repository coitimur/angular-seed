angular.module('layout.services.theme',['ngStorage'])
.service('$theme',function($rootScope, EnquireService, $document,$localStorage) {
    'use strict';
    this.settings = {
      fixedHeader: true,
    ...
    this.get = function(key) {
	  if($localStorage.appSettings){
		  this.settings=$localStorage.appSettings;
	  }	
    ...
    this.set = function(key, value) {
	  ...
	  $localStorage.appSettings=this.settings;
