angular.module('charts-morrisjs', []);

angular.module('app').requires.push('charts-morrisjs');
...
.config(['$routeProvider', function($routeProvider) {
    ...
    $routeProvider
      .when('/charts-morrisjs', {
        template: '<charts-morrisjs></charts-morrisjs>',
        resolve: {
...
.component('chartsMorrisjs', {
    templateUrl: 'partials/charts-morris/charts-morris.template.html',
