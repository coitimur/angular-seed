angular.module('ui-alerts', []);

angular.module('app').requires.push('ui-alerts');

angular.module('ui-alerts')
.component('uiAlerts', {
    templateUrl: 'partials/ui-alerts/ui-alerts.template.html',
    controller: function($scope, pinesNotifications, $window) {
		var _ = $window._;
		$scope.alerts = [{
		  type: 'success',
