angular.module('form-xeditable', []);

angular.module('app').requires.push('form-xeditable');

angular.module('form-xeditable')
.component('formXeditable', {
    templateUrl: 'partials/form-xeditable/form-xeditable.template.html',
    controller: function($scope,$theme, $filter,dataFactoryModel) {
	     $scope.user = {
		  name: 'awesome user',
		  status: 2,
		  group: 4,
